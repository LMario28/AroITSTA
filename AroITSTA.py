...
LOGO_ELECTRONICA_RGB = [
    ...
    # Fila 9 (2f,1v+o,1vo,1v,1v+o,1a+o,2a,1ao,1a+o,1f,1a+o,1ao,2a,1ao,1v+o,1v,1vo,1v+o,3f)
    COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE, COLOR_VERDE_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 10 (3f,1v+o,1vo,1a+o,1ao,1a,1a+o,5f,1a+o,1a,1ao,1a+o,1vo,1v+o,4f)
    COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 11 (2f,1v+o,2vo,1ao,1a,1ao,1a+o,1f,1a+o,1ao,1a+o,1f,1a+0,1ao,1a,1ao,2vo,1v+o,3f)
    COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 12 (1f,1v+o,1vo,1v,1vo,1ao,1a,1a+o,1f,1a+o,1ao,1a,1ao,2a+o,1ao,1a,1ao,1v+o,1v,1vo,1v+o,2f)
    COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE, COLOR_VERDE_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO,
    # Fila 13 (1f,1v+o,2v,1v+o,1ao,1a,1a+o,1f,1ao,6a,1ao,1a+o,1v+o,2v,1v+o,2f)
    COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE, COLOR_VERDE, COLOR_VERDE_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE, COLOR_VERDE, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO,
    # Fila 14 (2f,1v+o,1vo,1v+o,1ao,1a,1ao,1f,1a+o,1ao,1a,1ao,5a+o,1v+o,1vo,1v+o,3f)
    COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 15 (2f,1v+o,1vo,1v,1a+o,1a,1ao,1a+o,1f,2a+o,2f,2a+o,1f,1v+o,1vo,1v+o,4f)
    COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 16  (2f,1v+o,1vo,1v,1vo,1a+o,1ao,1a,1ao,6a+o,1v+o,1vo,1v,1vo,1v+o,3f)
    COLOR_FONDO, COLOR_FONDO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE, COLOR_VERDE_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO, COLOR_AMARILLO_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_AMARILLO_MAS_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_VERDE_OPACO, COLOR_VERDE, COLOR_VERDE_OPACO, COLOR_VERDE_MAS_OPACO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 16
    COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
    # Fila 17
    COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO, COLOR_FONDO,
